  ...
  <div>
    <v-form ref="form" v-model="valid" lazy-validation>
      ...
      <v-select
        ...
        <v-btn color="primary" class="mr-12" @click="sumbit">
          提交
        </v-btn>
 ...
 export default {
   ...
   methods: {
     ...
     submit() {
       ...
       newUser.address = 
      `${this.addressSelect.province}${this.addressSelect.city}${this.addressSelrct.area}` 
      ...
      this.axios({
        ...
        console.log(JSON.stringify(res.data.ata))
