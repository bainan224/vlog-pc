<template>
  <div class="bg row">
    ...
    <v-dialog v-model="flag" max-width="500">
      <v-card>
        <v-card-title class="headline grey lighten-2">
          登陆成功
        </v-card-title>
        <v-img height="250" src="http://bnnbucket.oss-cn-hangzhou.aliyuncs.com/tou.jpg"></v-img>
        <v-card-text>
          现在进入我的博客
        </v-card-text>
...
.bg {
  width: 100%;
  height: 100vh;
  background: url('http://bnnbucket.oss-cn-hangzhou.aliyuncs.com/avatar/bg.jpg');
}
.mask {
